...
define(['backbone',
	...
	'global'], function(Backbone,StreetBlogContentView, global) {  

    var Hot24view = Backbone.View.extend({
        el: $('#container-fluid'),
		// setModel:function(){
		...
		render: function(blogtitle, blogcontent) {
			var container = $('<div class="categoryShow"></div>');
			this.$el.html(container);
			this.getMessage(hot24data);
			// add one blog
