    ...
    var SearchListView = Backbone.View.extend({
       el:".categoryShow",
		...
		containerBuild : function(){
            var container = $('<div class="container-box findbox hotstreet fn-clear"><div class="box-title" style="text-align:left;"><h2 style="margin-left:50px;">街区类别:<a class="streettype1" style="color:#333;"></a> > <a class="streettype2" style="color:#333;"></a></h2></div><div class="box-content-fluid"><div class="btn-nav nav-left fn-btn"><i class="iconfont">&#xe624;</i></div><div class="btn-nav nav-right fn-btn"><i class="iconfont">&#xe623;</i></div></div></div>');
		...
		render: function(datalist) {
			...
			_.each(this.collection.models, function(item,index) {
				var ex = /^\d+$/;
				if (ex.test(index / 3)) {
				    this.$el.find(".box-content-fluid").append('<div class="col-xs-12 itemgroup"><div class="row"></div></div>');
				}
		...
		renderTitle:function(item){
           this.$el.find(".streettype1").html(item.get('streettype1'));
           this.$el.find(".streettype2").html(item.get('streettype2'));
		},
