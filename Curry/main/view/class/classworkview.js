...
* 小喇叭作业模块
*/
define(['backbone','model/class/noticemodel','text!tpl/class/classworktpl.html','global'], function(Backbone,NoticeCollection,tpl,global) {   
    // 访问元素视图
	var WorkItemview = Backbone.View.extend({
		tagName: 'div',
		className: 'container-box list-content blog-listitem',
		workTemplate: _.template(tpl),
		initialize: function() {

        },
		render: function() {
			this.$el.html(this.workTemplate(this.model.toJSON()));
			return this;
		},
		events: {
    ...
    var ClassWorkView = Backbone.View.extend({
        //el: $('.categoryShow'),
