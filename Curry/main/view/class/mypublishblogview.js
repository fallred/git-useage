...
define(['backbone',
	...
	'text!tpl/class/mypublishblogtpl.html',
	'global'], function(Backbone,NoticeCollection,BlogContentView,tpl,global) {  

    var MyPublishBlogView = Backbone.View.extend({
        el: $('#container-fluid'),
        parent: null,
		...
		render: function() {
			...
			this.getMessage(blogdata1);
			//this.parent.intercept();
			
        },
        // 发布关闭
        events: {
			"click .blog-close2": "closePage"
		},
