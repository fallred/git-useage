...
function regist(){
	form1.action="<%=basePath%>user/chekUserName"
	form1.submit();
}
</script>
<script language="javascript" type="text/javascript">
	...
	<body>
		...
		<div class="main">
			<div class="main-top">
				<div class="row">
					<div class="col-xm-6 col-xs-8">
						<ul class="counts">
							<li class="tip back-r"><p>输入账号</p></li>
							<li class="sign">></li>
			...
			<div class="main-container">
				<div class="content">
					<form name="form1" method="post"  "formTest" fv-validate="true" fv-msgpanel="formerror" action="">
						<div class="formList">
							<div class="row" >
								<div class="col-xs-4 col-sm-4"></div>
								<div class="col-xs-8 col-sm-8">
									<div class="formList-det">
										<input type="text"  name="username" class="formList-width1" fv-empty="false" fv-empty-msg="用户名不能为空！" fv-msgpanel="msgyhm" placeholder="请输入手机号/邮箱/童年号/用户名" />
										<label  class="info">账号</label>
										<span id="msgyhm" class="validate-info">请输入账号！</span>
									</div>
								</div>
								...
								<div class="col-xs-8 col-sm-8">
									<div class="formList-det">
										...
										<a href="javascript:void(document.form1.submit())" onclick="regist();" class="btn-bg btn-width btn-text btn-margintb">下一步</a>
									</div>
								</div>
							</div>
						</div>
