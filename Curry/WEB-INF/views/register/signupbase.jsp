...
function regist(){
	form1.action="<%=basePath%>register/studentRegistUser"
	form1.submit();
}
</script>
...
${msg }
							<div class="row" >
								...
								<div class="col-xs-8 col-sm-8">
									<div class="formList-det">
										<a href="javascript:void(document.form1.submit())" onclick="regist();" class="btn-bg btn-width btn-text btn-margintb">立即注册</a>
									</div>
								</div>
							</div>
						</div>
