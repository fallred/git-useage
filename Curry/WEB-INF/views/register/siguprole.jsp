	...
	<div class="main">
		<div class="container">
			<div class="role">
				...
				<span><a href="<%=basePath%>register/siguproleS">学生</a></span>
			</div>
			<div class="role">
				<span><a href="<%=basePath%>register/siguproleT">教师</a></span>
			</div>
			<div class="role">
				<span><a href="<%=basePath%>register/siguproleP">家长</a></span>
			</div>
			<div class="role">
				<span><a href="">机构/公众号</a></span>
			</div>
		</div>
	</div>
