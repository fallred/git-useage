...
function checkForm(){
	form1.action="<%=basePath%>register/parentRegistUserFullinfo"
	form1.submit();
}
</script>
		...
		<div class="main">
			<div class="main-container">
				<div class="content">
					...
					<form id="formTest" name="form1" method="post" "true" fv-msgpanel="formerror" action="<%=basePath%>register/parentRegistUserFullinfo">
						<div class="formList">
							<div class="row">
							...
							<div class="col-xs-8 col-sm-8">
								<div class="formList-det">
									<label class="info">孩子所在学校</label>
									<input type="text"  class="formList-width1" id="school" name="school" value="123" readonly="readonly"  fv-empty="false" fv-empty-msg="学校不能为空！" fv-msgpanel="msgxx" />
									...
									<div class="selecter">
										<div class="selecter-container">
											...
											<ul class="selecter-options">
												<li><a href="javascript:void(0)" value="1">2000</a></li>
												<li><a href="javascript:void(0)" value="2">2001</a></li>
											</ul>
										</div>
									</div>
									<!-- 下拉框 -->
									<div class="selecter margin-l">
										<div class="selecter-container">
											<div class="selecter-trigger">
											<input type="text" data-id="0" value="请选择" disabled="true ">
											<i class="iconfont">&#xe61f;</i>
