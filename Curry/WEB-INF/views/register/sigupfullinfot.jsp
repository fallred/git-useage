...
<html lang="en">
  <head>
    ...
    <title>sigupfullinfot.jsp</title>
  ...
  <body>
		...
		<div class="main">
			<div class="container">
				...
				<div class="content">
					<form id="formTest" fv-validate="true" fv-msgpanel="formerror" action="<%=basePath%>register/teacherRegistUserFullinfo" method="post">
						<dl class="formList">
							...
							<dt class="formList-tit">所教科目：</dt>
							<dd class="formList-det classes" numlimit="3">
								<ul class="select-items">
									<li>语文<i class="close">×</i></li>
									<li>数学<i class="close">×</i></li>
									<li class="addclass">新增</li>
								</ul>
							</dd>
		...
		<div class="dialog classes">
			...
			<div class="dialog-content clearfix">
				<ul class="select-items">
					<li>语文<i class="close">×</i></li>
					<li>数学<i class="close">×</i></li>
					<li>英语<i class="close">×</i></li>
					<li>物理<i class="close">×</i></li>
					<li>化学<i class="close">×</i></li>
					<li>生物<i class="close">×</i></li>
				</ul>
			</div>
		</div>
		...
		<input type="hidden" id="interestsval" name="interests">
		<input type="hidden" id="subjectsval" name="subjects">
		<input type="hidden" value="${userinfo.username}" name="username">
		<script>
		
		//兴趣取值jq
		var c=[],
		 	a = $(".formList-det.interests .select-items li[value]");
		for(i = 0; i< a.length; i++){
		var b = a.eq(i).attr("value"); c.push(b)
		};
		$("#interestsval").val(c.toString());
		</script>
		...
		//兴趣取值jq
		var f=[],
		 	d = $(".formList-det.classes .select-items li[value]");
		for(j = 0; j< d.length; j++){
		var e = d.eq(j).attr("value"); f.push(e)
		};
		$("#subjectsval").val(f.toString());
		</script>
		<script>
